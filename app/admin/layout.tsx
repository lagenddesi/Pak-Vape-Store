export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <nav className="p-4 bg-slate-800 border-b border-purple-500/30 flex justify-between items-center">
        <h1 className="text-xl font-bold text-purple-400 font-mono">PAK VAPE ADMIN</h1>
