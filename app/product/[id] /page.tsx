...
export default function ProductDetail({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-white p-6">
      <button onClick={() => window.location.href='/'} className="mb-6 flex items-center gap-2 text-slate-400"><ArrowLeft size={16}/> Back</button>
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-10">
        ...
        <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
          ...
          <p className="text-2xl text-purple-500 font-bold mb-6 text-green-500 font-black">Rs. {product.price}</p>
          <form onSubmit={handleOrder} className="space-y-4">
            ...
            <button type="submit" disabled={isOrdering} className="w-full bg-purple-600 py-4 rounded-xl font-bold uppercase hover:bg-purple-700 transition">
